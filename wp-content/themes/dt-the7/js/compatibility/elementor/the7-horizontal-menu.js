        ...
        methods = {
            ...
            handleItemsClick: function () {
                $ulMenu.each(function () {
                    ...
                    $(" li.has-children ", $mainNav).each(function () {
                        ...
                        if (($widget.hasClass('show-sub-menu-on-hover') || $widget.hasClass('parent-item-clickable-yes')) && !methods.isDropdown()) {
            ...
            showSubMenu: function ($el) {
                ...
                visibilityTimeout = setTimeout(function () {
                    if ($thisPar.hasClass("dt-hovered") && !methods.isDropdown()) {
