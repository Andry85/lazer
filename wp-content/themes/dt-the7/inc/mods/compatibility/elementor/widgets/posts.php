...
class Posts extends The7_Elementor_Widget_Base {
	...
	protected function render() {
		...
		$terms = [];
		if ( $settings['show_categories_filter'] !== 'hide' || $settings['show_categories_filter_tablet'] !== 'hide' || $settings['show_categories_filter_mobile'] !== 'hide' ) {
	...
	protected function add_container_attributes( $element ) {
		...
		if ( $settings['show_categories_filter'] !== 'hide' || $settings['show_categories_filter_tablet'] !== 'hide' || $settings['show_categories_filter_mobile'] !== 'hide' || $settings['show_orderby_filter'] || $settings['show_order_filter'] ) {
