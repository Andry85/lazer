		...
		$this->add_basic_responsive_control(
			...
			[
				...
				'selectors'  => [
					...
					' {{WRAPPER}} .horizontal-menu-dropdown .dt-nav-menu-horizontal--main' => 'width: calc({{SIZE}}{{UNIT}} - var(--sub-menu-right-gap, 0px) - var(--sub-menu-left-gap, 0px)); --sub-menu-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
